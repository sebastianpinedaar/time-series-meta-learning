...
def main(args):
    ...
    for trial in range(lower_trial, upper_trial):
        ...
        val_error = test(maml, model_name, validation_data_ML, adaptation_steps, learning_rate)
        ...
        validation_error = test(maml, model_name, validation_data_ML, adaptation_steps, learning_rate)
        validation_error2 = test(maml, model_name, validation_data_ML, adaptation_steps, learning_rate, with_early_stopping=True)
        validation_error3 = test(maml, model_name, validation_data_ML, 10, learning_rate, with_early_stopping=True)
        validation_error4 = test(maml, model_name, validation_data_ML, 10, learning_rate*0.1, with_early_stopping=True)

        test_error = test(maml, model_name, test_data_ML, adaptation_steps, learning_rate)
        test_error2 = test(maml, model_name, test_data_ML, adaptation_steps , learning_rate, with_early_stopping=True)
        test_error3 = test(maml, model_name, test_data_ML, 10 , learning_rate, with_early_stopping=True)
        test_error4 = test(maml, model_name, test_data_ML, 10, learning_rate*0.1, with_early_stopping=True)
